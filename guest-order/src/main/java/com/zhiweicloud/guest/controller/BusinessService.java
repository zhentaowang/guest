...
public class BusinessService implements IBusinessService {
    ...
    @Autowired
    public BusinessService(OrderInfoController orderInfoController, OrderServiceRecordController orderServiceRecordController, PassengerController passengerController) {
