...
import com.zhiweicloud.guest.service.IPassengerService;
...
public class ProductServiceImpl implements MyService.Iface {
    ...
    private final IPassengerService iPassengerServiceImpl;

    @Autowired
    public ProductServiceImpl(IPassengerService iPassengerServiceImpl) {
        this.iPassengerServiceImpl = iPassengerServiceImpl;
    }
    ...
    public Response send(Request request) throws TException {
        ...
        String result;
        result = iPassengerServiceImpl.handle(paramJSON);
