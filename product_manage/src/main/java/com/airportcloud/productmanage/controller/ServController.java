...
public class ServController {
    ...
    public LZResult<List<Serv>> servList(
            @RequestParam(value = "airportCode", required = true, defaultValue = "LJG") String airportCode,
        ...
        LZResult<List<Serv>> result  = servService.getServAll(param,price,freeRetinueNum,overStaffUnitPrice);
        return result;
    }
